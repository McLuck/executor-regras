 ...
 */
package br.com.lucasisrael.regra.reflections;
 ...
 * @author Chris Beams
 * 
 * 15/11/2015 - @author Lucas Israel - Criando novas funções para a classe. <br>
 *<br>
 *<br>
 * LISTA DE CLASSES INTERNAS: <br>
 */
public class TratamentoReflections {
	...
	/**
	 * Will handle chained field as person.address.number <br>
	 * Get the field represented by the supplied {@link Field field object} on the
	 * specified {@link Object target object}. In accordance with {@link Field#get(Object)}
	 * semantics, the returned value is automatically wrapped if the underlying field
	 * has a primitive type.
	 * <p>Thrown exceptions are handled via a call to {@link #handleReflectionException(Exception)}.
	 * @param target serarch target object
	 * @param fieldName field name separated by dot when chained
	 * @return
	 */
	public static Object getField(Object target, final String fieldName) {
		String[] fields = fieldName.split("\\.");
		for (String aFieldName : fields) {
			Field field = findField(target.getClass(), aFieldName);
			if(field!=null) {
				makeAccessible(field);
